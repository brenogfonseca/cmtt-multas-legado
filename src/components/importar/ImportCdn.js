...
export default function ImportCdn({ formSubmitted, stateCdn, stateDb }) {
            ...
            <Grid item xs={12}>
              {responseDiario.status === "error" ? (
                ...
                <Button
                  ...
                  fullWidth
                  variant="contained"
                  href={`https://api.anapolis.go.gov.br/apiupload/cmtt/penalidade/${stateCdn.responseDiario.pathFile}`}
                  target="_blank"
                >
                  PDF Diário
                </Button>
